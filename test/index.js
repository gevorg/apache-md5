...
describe('apache-md5', function () {
    ...
    it('valid password', function () {
        const encrypted = md5("su/P3R%se#ret!", "$apr1$cF.rAvCe$YlzjmK4qu/ia6hC8CNfnm/");
    ...
    it('invalid password', function () {
        const encrypted = md5("invalidPass", "$apr1$cF.rAvCe$YlzjmK4qu/ia6hC8CNfnm/");
    ...
    it('invalid short password', function () {
        const encrypted = md5("passw0rdpa55wore", "$1$VV5.4y5.$9981ZZhKTHmeXFKQur4cV0");
